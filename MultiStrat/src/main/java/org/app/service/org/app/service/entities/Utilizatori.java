...
public int hashCode() {
	...
	int result = 1;
	result = prime * result
			+ ((EmailUtilizator == null) ? 0 : EmailUtilizator.hashCode());
	result = prime * result + IdUtilizator;
	result = prime * result
			+ ((NumePrenume == null) ? 0 : NumePrenume.hashCode());
	return result;
}
...
public String toString() {
	return "Utilizatori [IdUtilizator=" + IdUtilizator + ", NumePrenume="
			+ NumePrenume + ", EmailUtilizator=" + EmailUtilizator + "]";
}
public Utilizatori() {
	super();
}
